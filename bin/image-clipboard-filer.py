#!/usr/bin/python2
"""
https://gist.github.com/orschiro/8b9a1ddadb696c2b4587#file-image-clipboard-to-file-py
...
location = expanduser('~/Screenshots/')
...
if image is not None:
    image.save(location+fname, "png")
    print "PNG image saved to file", location+fname
    if options.open:
        import subprocess
        subprocess.call(["xdg-open", location+fname])
else:
